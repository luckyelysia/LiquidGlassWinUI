// Card 4 stage1 — N=1 relay. FlattenSource passthrough with keepAsFragmentOutput=false.
// Re-materializes upstream fragment output into a clean texture for non-flatten consumers.
// ABI: flattenSourceBeforeCustomSampler=true, sourceCount=1, keepAsFragmentOutput=false,
