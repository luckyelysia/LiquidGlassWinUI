// Card 5 stage1 — N=2 cross-blend. Consumes stage0 (invert) output as texture0
// via FlattenSource materialization + color source.
...
{
    float4 _Params; // _Params.x = Factor (0=texture(inverted backdrop), 1=color)
};
