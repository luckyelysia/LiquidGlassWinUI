...
namespace LiquidGlassWinUI.Effects
{
    ...
    internal sealed class EffectProperty
    {
    ...
    // loads the HLSL (from an embedded resource) and assembles the projected
    // IGraphicsEffect through the shared builder. This mirrors the per-effect
    // .h/.cpp split in the C++ runtime (CustomInvertEffect / CustomBlurEffect /
    // CustomLiquidGlassEffect).
    internal abstract class CustomEffectBase
    {
        protected abstract Guid Id { get; }
        protected abstract string EffectName { get; }
        protected abstract string ShaderFileName { get; }     // embedded resource stem
        ...
        protected virtual bool HasCustomSamplers => true;
